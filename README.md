...
| 32 plugins | Go, Python, TypeScript, Java, C#, Rust, and [more](#supported-languages) |
...
<details>
<summary><strong>Install all 32 plugins</strong></summary>
...
| go install (gopls) | No | Scripts update current session PATH |
